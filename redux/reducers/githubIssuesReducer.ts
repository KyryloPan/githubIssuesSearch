import { ACTIONS_GITHUB_CLEAR_ISSUES, ACTIONS_GITHUB_GET_ISSUES_ERROR, ACTIONS_GITHUB_ISSUES_LOAD, ACTIONS_GITHUB_SET_ORGANIZATION_ID, ACTIONS_GITHUB_SET_PAGE, ACTIONS_GITHUB_SET_REPO_ID } from "../../constst/actions";
